...
val results : HtmlDocument =
  <!-- html>--><html lang="en">
  <head>
    <meta charset="UTF-8" /><meta content="/images/branding/googleg/1x/googleg_standard_color_128dp.png" itemprop="image" /><title>FSharp.Data - Google Search</title><script nonce="rG6JT0Ijcz+wBOxNm9HskA==">(function(){
...
val links : (string * string) list =
  [("Google", "/?sa=X&ved=0ahUKEwj3-rPqtJH1AhXDhHIEHVXlC8MQOwgC");
   ("Google",
    "/?output=search&ie=UTF-8&sa=X&ved=0ahUKEwj3-rPqtJH1AhXDhHIEHVXlC8MQPAgE");
   ("here", "/search?q=FSharp.Data&ie=UTF-8&gbv=1&sei=TbzQYbegPMOJytMP1cqvmAw");
   ("News",
