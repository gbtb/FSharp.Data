...
val stats : (string * decimal) [] =
  [|("4.2", 80395M); ("4.1", 77360M); ("4.0", 42500M); ("3.3", 709018M);
    ("3.2", 17804M); ("3.1", 192552M); ("3.0", 370795M); ("2.4", 407902M);
    ("2.3", 480829M); ("2.2", 285588M); ("2.1", 28526M); ("2.0", 86043M);
    ("1.1", 77002M); ("1.0", 25132M)|]*)
(**
