...
type public CsvProvider(cfg:TypeProviderConfig) as this =
    ...
    let helpText = 
        """<summary>Typed representation of a CSV file.</summary>
           ...
           <param name='MissingValues'>The set of strings recogized as missing values specified as a comma-separated string (e.g., "NA,N/A"). Defaults to <c>""" + String.Join(",", TextConversions.DefaultMissingValues) + """</c>.</param>
